 ...
 */
package edu.harvard.iq.rservice.utility;
...
public class RService implements java.io.Serializable {
    ...
    private static Logger dbgLog = Logger.getLogger(RService.class.getPackage().getName());

    private static RConnectionPool RConnectionPool = null; 
    ...
    public RService(){
        ...
        if ( RConnectionPool == null ) {
            ...
            RConnectionPool = new RConnectionPool ( RSERVE_CONNECTION_POOLSIZE );
        }
    ...
    public String initializeConnection(REXP initialData, String initialSetup, String savedRworkSpace) throws RServiceException {
        ...
        if (savedRworkSpace != null) {
            ...
            throw new RServiceException("Initialize method called without either a matrix or remote session data file");
        }


        if (myConnection == 0) {
            throw new RServiceException("failed to obtain an R connection");
        } else {
    ...
    public String initializeConnectionWithIntegerDataframe(int[][] cMatrix, String initialSetup, String savedRworkSpace) throws RServiceException {
        ...
        try {
            ...
            throw new RServiceException ("Data type mismatch: "+rmme.getMessage());
        }
    ...
    public String initializeConnectionWithDoubleDataframe(double[][] cMatrix, String initialSetup, String savedRworkSpace) throws RServiceException {
        RList rowVectorsList = new RList();
    ...
    public REXP executeRCommand(String savedRworkSpace, String rCommand) throws RServiceException {
        ...
        if (savedRworkSpace == null) {
            throw new RServiceException("execute method called with a null " 
        ...
        try {
            ...
            if (myConnection == 0) {
                throw new RServiceException("execute method called without securing a connection first");
            }
            ...
            if (!savedRworkSpace.equals(drc.getWorkSpace())) {
                throw new RServiceException("Could not execute query: connection lost");
            }

        } catch (RServiceException dre) {
            throw dre;

        } catch (RException re) {
            throw new RServiceException(re.getMessage());
            ...
            throw new RServiceException("RServe failure: " + rse.getMessage());

        } catch (REXPMismatchException mme) {

            throw new RServiceException("REXPmismatchException occured: " + mme.getMessage());

        } catch (Exception ex) {

            throw new RServiceException("Execute: unknown exception occured: " + ex.getMessage());
   ...
   /** *************************************************************
    ...
    public void assignRIntegerVector (String savedRworkSpace, String vectorName, int[] intVector) throws RServiceException {

        if (intVector == null) {
            throw new RServiceException("Assign method called with a NULL integer vector.");

        }


        if (savedRworkSpace == null) {
            throw new RServiceException("Assign method called with a null "
                    + "session Id (i.e. file name of the saved R work space).");
        }
        ...
        try {
            ...
            if (myConnection == 0) {
                throw new RServiceException("assignment method called without securing a connection first");
            }
   ...
   /** *************************************************************
    ...
    public void assignStringVector (String savedRworkSpace, String vectorName, String[] stringVector) throws RServiceException {

        if (stringVector == null) {
            throw new RServiceException("Assign method called with a NULL string vector.");
    ...
    public class RServiceException extends Exception {
        ...
        public RServiceException(String msg) {
            super(msg);
        }
    }
    ...
    public class RConnectionPool {
        ...
        private Logger dbgLog = Logger.getLogger(RConnectionPool.class.getPackage().getName());

        public RConnectionPool(int n) {
         ...
         */
         ...
         public int securePooledConnection(String workSpaceRemote, REXP initialData, boolean reestablishConnection, int existingConnection) throws RServiceException {
            ...
            //drc.unlockConnection();
                ...
                throw new RServiceException("init: R runtime error: " + re.getMessage());

            } catch (RServiceException dge) {
                throw dge;
            } catch (RserveException rse) {

                throw new RServiceException("init: RServe error: " + rse.getMessage());
            } catch (REXPMismatchException mme) {
                throw new RServiceException("init: REXP exception");
            } catch (Exception ex) {
                throw new RServiceException("init: unknown exception");
            }

            return retConnectionNumber;
        }

        public synchronized int openPooledConnection(String workSpaceRemote, int existingConnection) throws RServiceException {
            ...
            try {
                ...
                if (retConnectionNumber == 0) {
                    ...
                    if (mostIdleConnection > 0) {
                        ...
                        throw new RServiceException("Could not connect to R: all available connections are busy.");
                ...
                if (retConnectionNumber > 0 && drc != null && drc.Rcon.isConnected()) {
                    ...
                    throw new RServiceException("Failed to reestablish a connection to the R server.");
                }
            } catch (RServiceException dge) {
                throw dge;
            } catch (RserveException rse) {
